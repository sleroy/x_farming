...
local snow_golem_def = {
  ...
  arrow = "farming_addons:snowball_arrow",
  shoot_offset = 1,
  reach = 2,
  damage = 3,
  hp_min = 35,
  ...
  visual = "mesh",
  mesh = "farming_addons_snowman.b3d",
  drawtype = "front",
  textures = {
    {"farming_addons_snowman.png^farming_addons_snowman_pumpkin.png"},
  },
  ...
  drops = {
    ...
    {name = "farming_addons:seed_pumpkin", chance = 5, min = 1, max = 3}
  },
...
mobs:register_mob("farming_addons:snow_golem", snow_golem_def)

-- mobs:spawn({
--   name = "farming_addons:snow_golem",
--   nodes = {"default:desert_sand", "default:desert_stone", "default:sand", "default:sandstone", "default:silver_sand", "farming_addons:deco_stone_eye", "farming_addons:deco_stone_men", "farming_addons:deco_stone_sun"},
--   min_light = 0,
--   max_light = 20,
--   chance = 2000,
...
mobs:register_egg("farming_addons:snow_golem", "Snow Golem", "default_snow.png", 1)

-- shooting
mobs:register_arrow("farming_addons:snowball_arrow", {
  visual = "sprite",
  visual_size = {x = 1, y = 1},
